...
${nuget_cmd} install src/Neblio.API/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Neblio.API.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Neblio.API.dll \
-recurse:'src/Neblio.API/*.cs' \
-doc:bin/Neblio.API.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Neblio.API.dll was created successfully"
fi
