...
namespace IO.Swagger.Model
{
    ...
    public partial class IssueTokenRequest :  IEquatable<IssueTokenRequest>, IValidatableObject
    {
        ...
        public IssueTokenRequest(string IssueAddress = default(string), decimal? Amount = default(decimal?), decimal? Divisibility = default(decimal?), decimal? Fee = default(decimal?), bool? Reissuable = default(bool?), IssueTokenRequestFlags Flags = default(IssueTokenRequestFlags), IssueTokenRequestMetadata Metadata = default(IssueTokenRequestMetadata))
        {
