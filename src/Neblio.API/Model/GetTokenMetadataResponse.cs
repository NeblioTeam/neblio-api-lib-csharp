...
namespace Neblio.API.Model
{
    ...
    public partial class GetTokenMetadataResponse :  IEquatable<GetTokenMetadataResponse>, IValidatableObject
    {
        ...
        /// <param name="initialIssuanceAmount">Total tokens issued in initial issuance.</param>
        ...
        public GetTokenMetadataResponse(string tokenId = default(string), string someUtxo = default(string), decimal? divisibility = default(decimal?), bool? lockStatus = default(bool?), string aggregationPolicy = default(string), decimal? initialIssuanceAmount = default(decimal?), decimal? totalSupply = default(decimal?), decimal? numOfHolders = default(decimal?), decimal? numOfTransfers = default(decimal?), decimal? numOfIssuance = default(decimal?), decimal? numOfBurns = default(decimal?), decimal? firstBlock = default(decimal?), string issuanceTxid = default(string), string issueAddress = default(string), GetTokenMetadataResponseMetadataOfIssuance metadataOfIssuance = default(GetTokenMetadataResponseMetadataOfIssuance), GetTokenMetadataResponseMetadataOfUtxo metadataOfUtxo = default(GetTokenMetadataResponseMetadataOfUtxo))
        {
        ...
        /// </summary>
        /// <value>Total tokens issued in initial issuance</value>
        [DataMember(Name="initialIssuanceAmount", EmitDefaultValue=false)]
        public decimal? InitialIssuanceAmount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InitialIssuanceAmount: ").Append(InitialIssuanceAmount).Append("\n");
        ...
        public bool Equals(GetTokenMetadataResponse input)
        {
            ...
            return 
                ...
                (
                    this.InitialIssuanceAmount == input.InitialIssuanceAmount ||
                    (this.InitialIssuanceAmount != null &&
                    this.InitialIssuanceAmount.Equals(input.InitialIssuanceAmount))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InitialIssuanceAmount != null)
                    hashCode = hashCode * 59 + this.InitialIssuanceAmount.GetHashCode();
