...
namespace Neblio.API.Api
{
    ...
    public interface ITestnetNTP1Api : IApiAccessor
    {
        ...
        ApiResponse<GetTokenMetadataResponse> TestnetGetTokenMetadataWithHttpInfo (string tokenid);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataAsync (string tokenid);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataAsyncWithHttpInfo (string tokenid);
        /// <summary>
        /// Get UTXO Metadata of Token
        /// </summary>
        /// <remarks>
    ...
    public partial class TestnetNTP1Api : ITestnetNTP1Api
    {
        ...
        /// <param name="tokenid">TokenId to request metadata for</param>
        /// <returns>GetTokenMetadataResponse</returns>
        public GetTokenMetadataResponse TestnetGetTokenMetadata (string tokenid)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = TestnetGetTokenMetadataWithHttpInfo(tokenid);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tokenid">TokenId to request metadata for</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        public ApiResponse< GetTokenMetadataResponse > TestnetGetTokenMetadataWithHttpInfo (string tokenid)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
        ...
        /// <param name="tokenid">TokenId to request metadata for</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        public async System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataAsync (string tokenid)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = await TestnetGetTokenMetadataAsyncWithHttpInfo(tokenid);
             return localVarResponse.Data;
        ...
        /// <param name="tokenid">TokenId to request metadata for</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataAsyncWithHttpInfo (string tokenid)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling TestnetNTP1Api->TestnetGetTokenMetadata");
