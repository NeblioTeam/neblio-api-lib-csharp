...
namespace Neblio.API.Api
{
    ...
    public interface ITestnetNTP1Api : IApiAccessor
    {
        ...
        /// <exception cref="Neblio.API.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tokenid">TokenId to request metadata for</param>
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        ...
        ApiResponse<GetTokenMetadataResponse> TestnetGetTokenMetadataWithHttpInfo (string tokenid, decimal? verbosity = null);
        /// <summary>
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        ApiResponse<GetTokenMetadataResponse> TestnetGetTokenMetadataOfUtxoWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataAsync (string tokenid, decimal? verbosity = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataAsyncWithHttpInfo (string tokenid, decimal? verbosity = null);
        /// <summary>
        /// Get UTXO Metadata of Token
        /// </summary>
        /// <remarks>
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataOfUtxoAsync (string tokenid, string utxo, decimal? verbosity = null);
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataOfUtxoAsyncWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null);
        /// <summary>
        /// Information On an NTP1 Transaction
        /// </summary>
        /// <remarks>
    ...
    public partial class TestnetNTP1Api : ITestnetNTP1Api
    {
        ...
        /// <returns></returns>
        public TestnetNTP1Api(Neblio.API.Client.Configuration configuration = null)
        {
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>GetTokenMetadataResponse</returns>
        public GetTokenMetadataResponse TestnetGetTokenMetadata (string tokenid, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = TestnetGetTokenMetadataWithHttpInfo(tokenid, verbosity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        public ApiResponse< GetTokenMetadataResponse > TestnetGetTokenMetadataWithHttpInfo (string tokenid, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling TestnetNTP1Api->TestnetGetTokenMetadata");
            ...
            if (tokenid != null) localVarPathParams.Add("tokenid", this.Configuration.ApiClient.ParameterToString(tokenid)); // path parameter
            if (verbosity != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "verbosity", verbosity)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("TestnetGetTokenMetadata", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        public async System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataAsync (string tokenid, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = await TestnetGetTokenMetadataAsyncWithHttpInfo(tokenid, verbosity);
             return localVarResponse.Data;
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataAsyncWithHttpInfo (string tokenid, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling TestnetNTP1Api->TestnetGetTokenMetadata");
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>GetTokenMetadataResponse</returns>
        public GetTokenMetadataResponse TestnetGetTokenMetadataOfUtxo (string tokenid, string utxo, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = TestnetGetTokenMetadataOfUtxoWithHttpInfo(tokenid, utxo, verbosity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        public ApiResponse< GetTokenMetadataResponse > TestnetGetTokenMetadataOfUtxoWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        public async System.Threading.Tasks.Task<GetTokenMetadataResponse> TestnetGetTokenMetadataOfUtxoAsync (string tokenid, string utxo, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = await TestnetGetTokenMetadataOfUtxoAsyncWithHttpInfo(tokenid, utxo, verbosity);
             return localVarResponse.Data;
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> TestnetGetTokenMetadataOfUtxoAsyncWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling TestnetNTP1Api->TestnetGetTokenMetadataOfUtxo");
