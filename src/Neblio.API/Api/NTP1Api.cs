...
namespace Neblio.API.Api
{
    ...
    public interface INTP1Api : IApiAccessor
    {
        ...
        ApiResponse<GetTokenMetadataResponse> GetTokenMetadataWithHttpInfo (string tokenid, decimal? verbosity = null);
        /// <summary>
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        ApiResponse<GetTokenMetadataResponse> GetTokenMetadataOfUtxoWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetTokenMetadataResponse> GetTokenMetadataAsync (string tokenid, decimal? verbosity = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> GetTokenMetadataAsyncWithHttpInfo (string tokenid, decimal? verbosity = null);
        /// <summary>
        /// Get UTXO Metadata of Token
        /// </summary>
        /// <remarks>
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        System.Threading.Tasks.Task<GetTokenMetadataResponse> GetTokenMetadataOfUtxoAsync (string tokenid, string utxo, decimal? verbosity = null);
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> GetTokenMetadataOfUtxoAsyncWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null);
        /// <summary>
        /// Information On an NTP1 Transaction
        /// </summary>
        /// <remarks>
    ...
    public partial class NTP1Api : INTP1Api
    {
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>GetTokenMetadataResponse</returns>
        public GetTokenMetadataResponse GetTokenMetadata (string tokenid, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = GetTokenMetadataWithHttpInfo(tokenid, verbosity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        public ApiResponse< GetTokenMetadataResponse > GetTokenMetadataWithHttpInfo (string tokenid, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        public async System.Threading.Tasks.Task<GetTokenMetadataResponse> GetTokenMetadataAsync (string tokenid, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = await GetTokenMetadataAsyncWithHttpInfo(tokenid, verbosity);
             return localVarResponse.Data;
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> GetTokenMetadataAsyncWithHttpInfo (string tokenid, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling NTP1Api->GetTokenMetadata");
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>GetTokenMetadataResponse</returns>
        public GetTokenMetadataResponse GetTokenMetadataOfUtxo (string tokenid, string utxo, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = GetTokenMetadataOfUtxoWithHttpInfo(tokenid, utxo, verbosity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>ApiResponse of GetTokenMetadataResponse</returns>
        public ApiResponse< GetTokenMetadataResponse > GetTokenMetadataOfUtxoWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of GetTokenMetadataResponse</returns>
        public async System.Threading.Tasks.Task<GetTokenMetadataResponse> GetTokenMetadataOfUtxoAsync (string tokenid, string utxo, decimal? verbosity = null)
        {
             ApiResponse<GetTokenMetadataResponse> localVarResponse = await GetTokenMetadataOfUtxoAsyncWithHttpInfo(tokenid, utxo, verbosity);
             return localVarResponse.Data;
        ...
        /// <param name="verbosity">0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)</param>
        /// <returns>Task of ApiResponse (GetTokenMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetTokenMetadataResponse>> GetTokenMetadataOfUtxoAsyncWithHttpInfo (string tokenid, string utxo, decimal? verbosity = null)
        {
            // verify the required parameter 'tokenid' is set
            if (tokenid == null)
                throw new ApiException(400, "Missing required parameter 'tokenid' when calling NTP1Api->GetTokenMetadataOfUtxo");
